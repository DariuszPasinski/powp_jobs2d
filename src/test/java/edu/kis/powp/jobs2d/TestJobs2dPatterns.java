...
public class TestJobs2dPatterns {
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver testDriver = new DriverToDrawPanelAdapter();
		DriverFeature.addDriver("Buggy Simulator", testDriver);

        Job2dDriver solidLineDriver = new LineDrawerAdapter(LineFactory.getBasicLine());
        DriverFeature.addDriver("Solid line", solidLineDriver);
